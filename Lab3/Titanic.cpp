...
/*
    Constructor of the class titanic
    This constructor receive the path to the titanic file, read the file,
    create one passager per line and save it in a vector of passagers.
    At the end it returns the titanic object
*/
...
/*
    createPassager( string ) -> object
    The method receive a string, split the information of the string
    and create a object passager.
*/
...
/*
    split(string, char, string*) -> void
    The method receive a string, a character separator and a pointer string.
    iterate over the string saving in the characters index until it finds the
    character separator. During the process add each substring to the string* variable.
*/
...
/*
    printPassager(void) -> void
    the method print passagers names from the vector of passagers attribute.
*/
...
/*
    printOnePassager(int) -> void
    The method receive an index of the vector passager
    and print the attributes of the corresponding passager.
*/
